...
/** @version Sets the points and color and draws a box*/
...
public class Box extends Shape {
	...
	public Box(Point p1, Point p2, Color color, boolean nested) {
	...
	public void draw(Graphics g) {
		...
		g.drawRect(
				getP1().x,	//x
				getP1().y,	//y
				getP2().x - getP1().x,	//width
				getP2().y - getP1().y);	//height
	...
	public Shape createSmaller(int dec) {
		...
		return new Box(new Point(newX1, newY1), new Point(newX2, newY2), getColor(), true);
	}
